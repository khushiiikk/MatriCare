...
const Trimester2 = () => {
    ...
    const exercises = t.trimesterPages.trimester2.exercises.map((ex, index) => ({
        id: index + 1,
        title: ex.title,
        desc: ex.desc,
        steps: ex.steps,
        color: colors[index],
        image: trimesterExercises.trimester2[index]?.image,
        video: trimesterExercises.trimester2[index]?.video
    }));
        ...
        <div className="trimester-page">
            <div className="container">
                ...
                <header className="trimester-header">
                    <h1>{t.trimesterPages.trimester2.title}</h1>
                    <p className="subtitle">{t.trimesterPages.trimester2.subtitle}</p>
                </header>
                ...
                <div className="trimester-note" style={{ marginTop: '30px' }}>
                    <strong>{t.trimesterPages.trimester2.note}</strong> {t.trimesterPages.trimester2.noteText}
                </div>
            </div>
        </div>
    );
