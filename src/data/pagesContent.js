// Remaining Pages Content Translations
export const pagesContent = {
    en: {
        ...
        login: {
            ...
            appName: "MatriCare",
            tagline: "Track health, stay happy.",
            featureTags: ["Tracker", "AI Assistant", "Yoga"],
            joinTitle: "Join MatriCare",
            ...
            employeeIdPlaceholder: "Enter ASHA ID",
            ...
            lmpPlaceholder: "Select LMP date"
        },
        // Find Care
        findCare: {
            pageTitle: "Find Care",
            pageSubtitle: "Locate nearby healthcare facilities",
            categories: {
                asha: "ASHA Center",
        ...
        settings: {
            ...
            dataPrivacy: "Data Privacy Settings",
        ...
        reportHistory: {
            ...
            pageSubtitle: "View your medical reports",
        ...
        health: {
            ...
            viewRisks: "View Pregnancy Risks",
            viewSymptoms: "View Symptoms Guide"
        },
        // Chatbot
        chatbot: {
            ...
            quickHelp: {
                ...
                findCare: "Find Care",
                risks: "Pregnancy Risks"
            },
            orText: "or just ask me a question below",
    ...
    hi: {
        ...
        login: {
            welcomeTo: "स्वागत है",
            appName: "मैट्रीकेयर",
            tagline: "स्वास्थ्य ट्रैक करें, खुश रहें।",
            featureTags: ["ट्रैकर", "एआई सहायक", "योग"],
            joinTitle: "मैट्रीकेयर में शामिल हों",
            welcomeBack: "वापसी पर स्वागत है!",
            createAccount: "मुफ्त खाता बनाएं",
            rolePatient: "रोगी (माता)",
            ...
            employeeIdPlaceholder: "आशा आईडी दर्ज करें",
            dobLabel: "जन्म तिथि",
            ...
            lmpLabel: "अंतिम मासिक धर्म (एलएमपी)",
            lmpPlaceholder: "एलएमपी तिथि चुनें"
        },
        // Find Care
        findCare: {
            pageTitle: "देखभाल खोजें",
            pageSubtitle: "नजदीकी स्वास्थ्य सुविधाएं खोजें",
            categories: {
                asha: "आशा केंद्र",
        ...
        settings: {
            ...
            privacySection: "गोपनीयता और सुरक्षा",
            changePassword: "पासवर्ड बदलें",
            dataPrivacy: "डेटा गोपनीयता सेटिंग्स",
            saveBtn: "परिवर्तन सहेजें",
            cancelBtn: "रद्द करें"
        },
        // Report History
        reportHistory: {
            pageTitle: "रिपोर्ट इतिहास",
            pageSubtitle: "अपनी मेडिकल रिपोर्ट देखें",
        ...
        // Health Page
        health: {
            pageTitle: "स्वास्थ्य डैशबोर्ड",
            vitalsSection: "महत्वपूर्ण संकेत",
            uploadReport: "मेडिकल रिपोर्ट अपलोड करें",
            analyzeBtn: "रिपोर्ट का विश्लेषण करें",
            viewRisks: "गर्भावस्था जोखिम देखें",
            viewSymptoms: "लक्षण गाइड देखें"
        },
        // Chatbot
        chatbot: {
            headerTitle: "मैट्री एआई",
            welcomeTitle: "नमस्ते, मैं मैट्री हूं",
            welcomeSubtitle: "आपकी व्यक्तिगत गर्भावस्था साथी। आज मैं आपकी कैसे मदद कर सकती हूं?",
            quickHelp: {
                yoga: "योग गाइड",
                health: "स्वास्थ्य विश्लेषण",
                findCare: "देखभाल खोजें",
                risks: "गर्भावस्था जोखिम"
            },
            orText: "या नीचे मुझसे कोई प्रश्न पूछें",
            placeholder: "मुझसे कुछ भी पूछें...",
            suggestions: [
                "मुझे क्या खाना चाहिए?",
                "क्या पीठ दर्द सामान्य है?",
